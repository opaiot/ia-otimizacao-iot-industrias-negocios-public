# Inteligência Artificial, Otimização e IoT para Indústrias e Negócios

Bem-vindos ao repositório público do curso **Inteligência Artificial, Otimização e
IoT para Indústrias e Negócios**.

Aqui estão reunidos códigos, notebooks, imagens, serviços e materiais de apoio das
práticas desenvolvidas ao longo dos quatro módulos do curso.

Conheça o curso em [opaiot.icmc.usp.br](https://opaiot.icmc.usp.br/).

## Organização do curso

| Módulo | Conteúdo |
| --- | --- |
| [`M1`](./M1/README.md) | [Fundamentos de Dados e Aprendizado de Máquina](./M1/README.md) |
| [`M2`](./M2/README.md) | [Fundamentos de IoT e IIoT](./M2/README.md) |
| [`M3`](./M3/README.md) | [Computação Distribuída para IA Aplicada](./M3/README.md) |
| [`M4`](./M4/README.md) | [Otimização, Arquiteturas Industriais e MLOps](./M4/README.md) |
...
cd ia-otimizacao-iot-industrias-negocios-public
```
...
Caso encontre algum problema no material ou tenha uma sugestão, utilize a seção
...
[Apache License 2.0](LICENSE). Recursos de terceiros, incluindo imagens e materiais
adaptados, permanecem sujeitos às respectivas licenças e atribuições indicadas no
[NOTICE](NOTICE) e nos notebooks.
